    ...
    <div className="math-service-container">
      <div className="math-row-1">
        <div className="column-1-left">
          ...
          <div className="head-inner-text">
            Unlock 24/7 support from EarlyStart E-Tutors. Our expert tutors help kids excel in Number Work, Quantitative Reasoning, Mental and Mathematics, ensuring homework is done correctly and preparing them for examination. 
            <br /> <br />
      ...
      <div className="math-row-2">
        ...
        <div className="math-2-inner">
          ...
          <div className="math-2-inner-text">
            EarlyStart E-Tutors offers personalized, interactive tutoring designed specifically for beginners and elementary school pupils, provided by expert educators in Number Work, Quantitative Reasoning, and Mathematics. 
            <br /> <br />
            Improve your child's learning experience with EarlyStart E-Tutors.
          </div>
          </div>
        </div>
      </div>
